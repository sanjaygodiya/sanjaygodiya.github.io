;(function () {
	...
	var mobileMenuOutsideClick = function() {
	    ...
	    var container = $("#mobmenu, .js-nav-toggle");
	...
	var offcanvasMenu = function() {
		...
		$('#page').prepend('<div id="mobmenu" />');
		$('#page').prepend('<a href="#" class="js-nav-toggle nav-toggle nav-white"><i></i></a>');
		var clone1 = $('.menu-1 > ul').clone();
		$('#mobmenu').append(clone1);
		var clone2 = $('.menu-2 > ul').clone();
		$('#mobmenu').append(clone2);

		$('#mobmenu .has-dropdown').addClass('offcanvas-has-dropdown');
		$('#mobmenu')
			.find('li')
